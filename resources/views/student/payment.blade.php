                              ...
                              <div class="col-sm-6">
                                <div class="row">
                                    <div class="col-sm-3">
                                      ...
                                      <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" value="{{ old('admission_number', $getRecord->class_name) }}" placeholder="Admission Number" name="class_name" required>
                                        @error('class_id')
                                          <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                      </div>
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-sm-6">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label for="class">Unit <span style="color: red">*</span></label>
                                      </div>
                                      <div class="col-sm-8">
                                        <input type="text" class="form-control" id="name" value="{{ old('unit_name', $getRecord->unit_name) }}" name="unit_name" disabled>
                                        @error('unit_name')
                                          <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                      </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="text" class="form-control" value="{{ now()->format('Y-m-d h:i:s A') }}" name="blood_group">
                                          @error('blood_group')
                                              <div class="alert alert-danger">{{ $message }}</div>
                                          @enderror
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                                  ...
                                  <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-4">
                                          ...
                                          <div class="col-sm-8">
                                            <input type="text" class="form-control" id="name" value="{{ old('name', $getRecord->name) }}        {{ $getRecord->last_name }}" name="name">
                                          </div>
                                    </div>
                                  </div>
                                  <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <label for="class">Class</span></label>
                                          </div>
                                          <div class="col-sm-9">
                                            <input type="text" class="form-control" id="name" value="{{ old('admission_number', $getRecord->class_name) }}" placeholder="Admission Number" name="class_name" required>
                                            @error('class_id')
                                  ...
                                  <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-4">
                                          ...
                                          <div class="col-sm-8">
                                            <input type="text" class="form-control" id="name" value="{{ old('admission_number', $getRecord->admission_number) }}" name="admission_number">
                                          </div>
                                        </div>
                                  </div>
                                  <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-3">
                                          ...
                                          <div class="col-sm-9">
                                            <img src="https://www.paymentscardsandmobile.com/wp-content/uploads/2021/09/M-Pesa-green.jpg" alt="payment by mpesa" class="fluid" style="width: 100%; height:40px">
                                  ...
                                  <div class="form-group">
                                    <div class="row">
                                      ...
                                      <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <label for="class">Amount</span></label>
                                              </div>
                                              <div class="col-sm-9">
                                                <h4>12000</h4>
                                              </div>
                            ...
                            <div class="modal-footer">
                              ...
                              {{-- <a type="submit"  class="btn btn-primary">Check Out</a> --}}
                            </div>
                          </div>
                        </div>
                      </div>
