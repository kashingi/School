...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
          <div class="text-sm-right">
            <a href="{{ url('admin/ClassTeacher/add') }}" class="btn btn-primary">Assign Class Teacher</a>
        </div>
        </ul>
    </nav>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">  
                      <h1>Assign Class Teachers  ({{ $getRecord->total() }})</h1>
                  </div>
              </div>
          </div>
      </section>
                  ...
                  <div class="col-md-12">
                          ...
                          <div class="crad-body end-0">
                              <div class="row text-center mx-2 mt-2">
                                <div class="form-group col-sm-3">
                                  ...
                                  <input type="text" class="form-control text-center" name="class_name" id="" value="{{ Request::get('class_name') }}" placeholder="Class Name" autocomplete="off">
                                </div>
                                <div class="form-group col-sm-3">
                                  <label for="name">Teacher Name</label>
                                  <input type="text" class="form-control text-center" name="teacher_name" id="" value="{{ Request::get('teacher_name') }}" placeholder="Teacher Name" autocomplete="off">
                                </div>
                                ...
                                <div class="form-group col-sm-4">
                                  ...
                                  <a href="{{ url('admin/ClassTeacher/list') }}" class="btn btn-success mx-2">Reset</a>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div id="success-message" class="text-center">
                      ...
                      <div class="card" style="width: 100%">
                          <div class="card-header">
                              <h3 class="card-title">Class Teachers list</h3>
                          </div>
                                ...
                                <tbody>
                                    @foreach ($getRecord as $value)
                                      <tr>
                                        ...
                                        <td>
                                          <a href="{{ url('admin/ClassTeacher/edit/'. $value->id) }}" class="btn btn-primary">
                                              <i class="fa fa-edit"></i>
                                              Edit
                                          </a>
                                          {{-- <a href="{{ url('admin/ClassTeacher/delete/'. $value->id) }}" class="btn btn-danger">
                                              <i class="fas fa-trash"></i>
                                              Delete
                                          </a> --}}
                                          <a href="#" class="btn btn-danger" onclick="confirmDelete('{{ url('admin/ClassTeacher/delete/'. $value->id) }}')">
                                            <i class="fas fa-trash"></i>
                                            Delete
                                          </a>
                                      </td>
    ...
    <script>
        ...
        //create function to confirm the deletion of the class teacher
        function confirmDelete(deleteUrl) {
        var confirmation = confirm("Are you sure you want to delete this Class Teacher ?");
