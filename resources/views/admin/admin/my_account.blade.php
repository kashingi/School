          ...
          <ul class="nav nav-pills nav-sidebar flex-column" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ url('admin/parent/list') }}" class="nav-link">
                <i class="nav-icon fa-person-booth"></i>
                <p>Parents</p>
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="{{ url('admin/ClassTeacher/list') }}" class="nav-link">
                            ...
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                <div class="row">
                                  ...
                                  <div class="col-sm-10">
                                    <input type="email" class="form-control" value="{{ old('email', $getRecord->email) }}" placeholder="Email" name="email" required>
                                    @error('email')
