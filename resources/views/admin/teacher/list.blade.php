                  ...
                  <div class="col-md-12">
                            ...
                            <div class="crad-body end-0">
                                <div class="row text-center mx-2 mt-2">
                                  ...
                                  <div class="form-group col-sm-2">
                                    ...
                                    <input type="text" class="form-control text-center" name="mobile_number" id="" placeholder="Admision Number" autocomplete="off">
                                  </div>
                                  <div class="form-group col-sm-2">
                                  ...
                                  <div class="form-group col-sm-3">
                                    ...
                                    <a href="{{ url('admin/teacher/list') }}" class="btn btn-success mx-2">Reset</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                    ...
                    <div id="success-message" class="col-sm-12">
                      ...
                      <div class="card" style="width: 100%">
                          <div class="card-header">
                              <h3 class="card-title">Techers List</h3>
                          </div>
                                    ...
                                    @foreach ($getRecord as $value)
                                        <tr>
                                            ...
                                            <td style="min-width: 200px" class="d-flex">
                                                ...
                                                <a href="#" class="btn btn-danger" onclick="confirmDelete('{{ url('admin/teacher/delete/'. $value->id) }}')">
                                                  <i class="fas fa-trash"></i>
                                                  Delete
                                                </a>
                                            </td>
