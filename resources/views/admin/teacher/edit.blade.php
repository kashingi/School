      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ url('/admin/student/lisyt') }}" class="nav-link">
                                        ...
                                        <div class="col-sm-4">
                                          ...
                                          <div class="col-sm-8">
                                            <select class="form-control" required name="marital">
                                              ...
                                              <option {{ (old('gender', $getRecord->marital) == 'Single') ? 'selected' : ''}} value="Single">Single</option>
                                              <option {{ (old('gender', $getRecord->marital) == 'Married') ? 'selected' : ''}} value="Married">Married</option>
                                              <option {{ (old('gender', $getRecord->marital) == 'Divorced') ? 'selected' : ''}} value="Divorced">Divorced</option>
                                              <option {{ (old('gender', $getRecord->marital) == 'Separated') ? 'selected' : ''}} value="Separated">Separated</option>
