                                ...
                                <div class="row">
                                  <div class="col-sm-6">
                                    <div class="row">
                                      ...
                                      <div class="col-sm-8">
                                        <input type="text" class="form-control" id="name" value="{{ old('addmision_date') }}" placeholder="Identity Number" name="admission_number" required>
                                  ...
                                  <div class="col-sm-6">
                                    <div class="row">
                                      <div class="col-sm-3">
                                        <label for="name">Experience</span></label>
                                      </div>
                                      <div class="col-sm-9">
                                        <input type="text" class="form-control" required value="{{ old('experince') }}" name="experince" required placeholder="Years Of Experience">
                                        @error('experince')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                      </div>
                              ...
                              <div class="form-group">
                                <div class="row">
                                  <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label for="class">Marital <span style="color: red">*</span></label>
                                          </div>
                                          <div class="col-sm-8">
                                            <select class="form-control" required name="marital">
                                              <option value="">Select Marital status</option>
                                              <option {{ (old('marital') == 'Single') ? 'selected' : ''}} value="single">Single</option>
                                              <option {{ (old('marital') == 'Married') ? 'selected' : ''}} value="maried">Married</option>
                                              <option {{ (old('marital') == 'Divorced') ? 'selected' : ''}} value="divorced">Divorced</option>
                                              <option {{ (old('marital') == 'Separated') ? 'selected' : ''}} value="Separated">Separated</option>
                                            </select>
                                            @error('class_id')
                                              <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                              ...
                              <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label for="name">Mobile Number <span style="color: red">*</span></span></label>
                                                </div>
                                                <div class="col-sm-8">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" required value="{{ old('mobile_number') }}" name="mobile_number" required placeholder="Mobile number" disabled>
                                                    @error('mobile_number')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                ...
                                <div class="row">
                                  <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label for="name">Date Joined<span style="color: red">*</span></label>
                                          </div>
                                          <div class="col-sm-8">
