      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ url('admin/unit/list') }}" class="nav-link active">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="name" value="{{ $getRecord->name }}" placeholder="Unit Name" name="name" required>
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="type" id="" class="form-control" required>
                                                    ...
                                                    <option {{ ($getRecord->type == 'optional') ? 'selected' : '' }} value="optional">Optional</option>
                                                </select>
                                            </div> 
                                        </div>
                                    </div> 
