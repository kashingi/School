...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
          <div class="text-sm-right">
            <a href="{{ url('admin/unit/add') }}" class="btn btn-primary">Add New Unit</a>
        </div>
        </ul>
                            ...
                            <div class="crad-body end-0">
                                <div class="row text-center mx-2 mt-2">
                                  <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" class="form-control text-center" name="name" id="" value="{{ Request::get('name') }}" placeholder="Name" autocomplete="off">
                                  </div>
                                  <div class="form-group col-sm-4">
                                    <label for="name">Unit Type</label>
                                    <select name="type" id="" class="form-control">
                                      <option value="">Select Value</option>
                                      <option {{ (Request::get('type') == 'core') ? 'selected' : '' }} value="core">Core</option>
                                      <option {{ (Request::get('type') == 'optional') ? 'selected' : '' }} value="optional">Optional</option>
                                    </select>
                                  </div>
                                  <div class="form-group col-sm-4">
                                    <label for="">Action</label><br>
                                    <button class="btn btn-primary" type="submit">Search</button>
                                    <a href="{{ url('admin/unit/list') }}" class="btn btn-success mx-2">Reset</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($getRecord as $value)
                                      <tr>
                                        ...
                                        <td>
                                          <a href="{{ url('admin/unit/edit/'. $value->id) }}" class="btn btn-primary">
                                              <i class="fa fa-edit"></i>
                                              Edit
                                          </a>
                                          {{-- <a href="{{ url('admin/unit/delete/'. $value->id) }}" class="btn btn-danger">
    ...
    <script>
        ...
        // create a function to confirm if the user wants to delete the unit
