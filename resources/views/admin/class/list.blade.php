...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="../class/list" class="nav-link active">
                            ...
                            <div class="crad-body end-0">
                                <div class="row text-center mx-2 mt-2">
                                  ...
                                  <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" class="form-control text-center mx-2" name="status"  id="" placeholder="Status" autocomplete="off" disabled>
                                  </div>
                                  <div class="form-group col-sm-4">
                                    <label for="">Action</label><br>
                                    <button class="btn btn-primary" type="submit">Search</button>
                                    <a href="{{ url('admin/class/list') }}" class="btn btn-success mx-2">Reset</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                                    ...
                                    @foreach ($getRecord as $value)
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          <a href="#" class="btn btn-danger" onclick="deleteClass('{{ url('admin/class/delete/'. $value->id) }}')">
                                            <i class="fas fa-trash"></i>
                                            Delete
                                          </a>
                                        </td>
    ...
    <script>
        ...
        function deleteClass(deleteUrl) {
