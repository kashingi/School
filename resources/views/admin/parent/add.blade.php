                              ...
                              <div class="form-group">
                                <div class="row">
                                  <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-4">
                                          ...
                                          <div class="col-sm-8">
                                           <input type="text" class="form-control" value="{{ old('admission_number') }}" name="admission_number" placeholder="Identity Number">
                                  ...
                                  <div class="col-sm-6">
                                    <div class="row">
                                      <div class="col-sm-3">
                                        <label for="name">Children No</span></label>
                                      </div>
                                      <div class="col-sm-9">
                                        <input type="text" class="form-control" value="{{ old('experince') }}" name="experince" placeholder="Number Of Childern">
                                        @error('experince')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                          @enderror
                                      </div>
