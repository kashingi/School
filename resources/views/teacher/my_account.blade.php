  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
          <div class="container-fluid">
              <div class="row">
                <div id="success-message" class="col-sm-12 text-center">
                    @include('_message')
                </div>
                  <div class="col-md-12">
                              ...
                              <div class="form-group">
                                <div class="row">
                                  <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label for="class">Marital Status<span style="color: red">*</span></label>
                                          </div>
                                          <div class="col-sm-8">
                                            <input type="text" class="form-control" value="{{ old('marital',  $getRecord->marital) }}" name="marital" placeholder="Marital Status">
                                            @error('marital')
                                              <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                          </div>
                              ...
                              <div class="form-group">
                                <div class="row">
                                  ...
                                  <div class="col-sm-6">
                                    <div class="row">
                                      <div class="col-sm-3">
                                        <label for="name">Id Number<span style="color: red">*</span></label>
                                      </div>
                                      <div class="col-sm-9">
                                        <input type="text" class="form-control" value="{{ old('admission_number', $getRecord->admission_number) }}" name="admission_number" placeholder="Id Number">
                              ...
                              <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="row">
                                          <div class="col-sm-4">
                                            <label for="password">Experience <span style="color: red"></span></label>
                                          </div>
                                          <div class="col-sm-8">
                                            <input type="text" class="form-control" required name="experince" value="{{ old('experince', $getRecord->experince) }}" placeholder="Years Of Experience">
                                            @error('experince')
                              ...
                              <div class="form-group">
                                <div class="row">
                                  ...
                                  <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-3">
                                          <label for="name">Date Of Birth</span></label>
                                        </div>
                                        <div class="col-sm-9">
                                          <input type="text" class="form-control" value="{{ old('date_of_birth', $getRecord->date_of_birth) }}" name="date_of_birth" placeholder=DAte Of Birth">
                                          @error('date_of_birth')
                                              <div class="alert alert-danger">{{ $message }}</div>
                                          @enderror
                                        </div>
                              ...
                              <div class="form-group">
                                <div class="row">
                                  <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label for="password">Joining Date<span style="color: red">*</span></label>
                                          </div>
                                          <div class="col-sm-8">
                                           <input type="text" class="form-control" value="{{ old('admision_date', $getRecord->admision_date) }}" name="admision_date" placeholder="Date Of Joining">
                                          @error('admision_date')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                          @enderror
                                        </div>
