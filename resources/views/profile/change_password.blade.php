...
<body class="hold-transition sidebar-mini layout-fixed">
                                    ...
                                    <div class="container-fluid w-50 mx-auto">
                                      <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="password" class="form-control text-center" id="name" placeholder="Old Password" name="old_password" required>
                                            </div>
                                        </div>
                                      </div> 
                                      <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="password" class="form-control text-center" id="name" placeholder="New Password" name="password" required>
                                                @error('password')
                                      ...
                                      <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="password" class="form-control text-center" id="name" placeholder="Confirm New Password" name="password_confirmation" required>
  ...
  <script>
    ...
    // Change the text color to blueviolet
