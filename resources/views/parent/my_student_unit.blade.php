        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton1">
              <li><a class="dropdown-item" href="{{ url('parent/change_password') }}">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">  
                      <h1>My Student Units <span class="text-info">({{ $getUser->name }} {{ $getUser->last_name }})</span></h1>
                  </div>
              </div>
          </div>
      </section>
                  ...
                  <div class="col-md-12">
                      ...
                      <div class="card" style="width: 100%">
                          <div class="card-header">
                              <h3 class="card-title">My Sudent Units</h3>
                          </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                  @if ($MyUnit)
                                    ...
                                    @endforeach
                                  @else
                                      <p>You have not registered for any unit.</p>
                                  @endif
