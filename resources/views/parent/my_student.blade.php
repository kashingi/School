      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="my_student" class="nav-link active">
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                            @if (!empty($value->getProfile()))
                                                <img src="{{ $value->getProfile() }}" alt="" style="height: 50px; width:50px; border-radius:50%">
                                            @endif
                                          </td>
                                          <td>{{ $value->name }}</td>
                                          ...
                                          <td>{{ $value->height }}</td>
                                          <td>
                                            <a class="btn btn-primary btn-sm" href="{{ url('parent/my_student/unit/'.$value->id) }}">Units</a>
                                          </td>
                                      </tr>
                                  @endforeach
                              </tbody>
